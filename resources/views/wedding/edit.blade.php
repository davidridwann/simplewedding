...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">Edit Wedding</div>
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('wedding.update', $data->id) }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="groom" type="text" class="form-control @error('groom') is-invalid @enderror" name="groom" value="{{ $data->groom }}" required autocomplete="groom" autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="bride" type="text" class="form-control @error('bride') is-invalid @enderror" name="bride" value="{{ $data->bride }}" required autocomplete="bride" autofocus>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <div class="input-group date" id="datetimepicker1" data-target-input="nearest">
                                            <input type="text" name="wedding_date" class="form-control datetimepicker-input" data-target="#datetimepicker1" value="{{ $data->wedding_date }}"/>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="love_story">{{ $data->love_story }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="wedding_info">{{ $data->wedding_info }}</textarea>
                                </div>
                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <div class="input-group date" id="datetimepicker2" data-target-input="nearest">
                                            <input type="text" class="form-control datetimepicker-input" data-target="#datetimepicker2" name="ceremony_date" value="{{ $data->ceremony_date }}"/>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="ceremony_place" type="text" class="form-control" name="ceremony_place" required value="{{ $data->ceremony_place }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="ceremony_address" type="text" class="form-control" name="ceremony_address" required value="{{ $data->ceremony_address }}">
                                </div>
                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <div class="input-group date" id="datetimepicker3" data-target-input="nearest">
                                            <input type="text" class="form-control datetimepicker-input" data-target="#datetimepicker3" name="reception_date" value="{{ $data->reception_date }}"/>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="reception_place" type="text" class="form-control" name="reception_place" required value="{{ $data->reception_place }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="reception_address" type="text" class="form-control" name="reception_address" required value="{{ $data->reception_address }}">
                                </div>
                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <div class="input-group date" id="datetimepicker4" data-target-input="nearest">
                                            <input type="text" class="form-control datetimepicker-input" data-target="#datetimepicker4" name="party_date" value="{{ $data->party_date }}"/>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="party_place" type="text" class="form-control" name="party_place" required value="{{ $data->party_place }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="party_address" type="text" class="form-control" name="party_address" required value="{{ $data->party_address }}">
                                </div>
                            </div>
